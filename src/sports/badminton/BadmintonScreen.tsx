...
interface SportScreenProps { spot: Spot; onBack: () => void; }

const BadmintonScreen: React.FC<SportScreenProps> = ({ spot, onBack }) => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        {spot.details && Object.keys(spot.details).length > 0 && (
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Infos Badminton</Text>
...
const styles = StyleSheet.create({
  ...
  backText: { fontFamily: 'DMSans_500Medium', fontSize: 15, color: '#FFFFFF' },
  headerEmoji: { fontSize: 40, marginBottom: 8 },
  headerTitle: { fontFamily: 'BarlowCondensed_700Bold', fontSize: 24, color: '#FFFFFF' },
  ...
  spotName: { fontFamily: 'BarlowCondensed_700Bold', fontSize: 20, color: '#FFFFFF', flex: 1, marginRight: 12 },
  address: { fontFamily: 'DMSans_400Regular', fontSize: 13, color: '#999999' },
  sectionTitle: { fontFamily: 'BarlowCondensed_600SemiBold', fontSize: 17, color: '#FFFFFF', marginBottom: 12 },
  equipements: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  equipBadge: { backgroundColor: '#2A2A2A', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 10 },
  equipText: { fontFamily: 'DMSans_400Regular', fontSize: 13, color: '#999999' },
  detailRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.08)' },
  detailLabel: { fontFamily: 'DMSans_400Regular', fontSize: 15, color: '#999999' },
  detailValue: { fontFamily: 'DMSans_600SemiBold', fontSize: 15, color: '#FFFFFF' },
  ...
  actionButtonText: { fontFamily: 'DMSans_600SemiBold', fontSize: 15, color: '#FFFFFF' },
});
