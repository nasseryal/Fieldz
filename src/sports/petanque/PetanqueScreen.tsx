...
const PetanqueScreen: React.FC<SportScreenProps> = ({ spot, onBack }) => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        {/* Section spécifique Pétanque */}
        {spot.details && (
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Infos Pétanque</Text>
