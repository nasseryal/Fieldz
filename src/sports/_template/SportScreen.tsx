// ============================================================
// TEMPLATE — Écran détail d'un spot
// ============================================================
// Cet écran s'affiche quand l'utilisateur tape sur "Détails"
// Chaque sport peut personnaliser la section "Infos spécifiques"
// ============================================================
...
const SportScreen: React.FC<SportScreenProps> = ({ spot, onBack }) => {
  // Ouvre l'app de navigation (Google Maps / Apple Plans)
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        {/* ============================================================
            SECTION SPÉCIFIQUE AU SPORT — À PERSONNALISER
            Exemples :
            - Football : nombre de joueurs, type terrain
            - Tennis : surface, nombre de courts
            - Skate : type de spot (bowl/street)
            ============================================================ */}
        {spot.details && Object.keys(spot.details).length > 0 && (
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>
              Infos {sportConfig.name}
            </Text>
        ...
        <View style={styles.actions}>
          <TouchableOpacity
            style={[styles.actionButton, { backgroundColor: sportConfig.color }]}
